  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-black border border-gray-800 rounded-xl p-4 sm:p-6 overflow-x-auto">
        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6">熱門藝人播放次數</h3>
      ...
      <div className="bg-black border border-gray-800 rounded-xl p-4 sm:p-6">
        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6">藝人排行榜</h3>
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
          {topArtists.map((artist, index) => (
            <div key={artist.id} className="bg-gray-800/50 rounded-lg p-3 sm:p-4 hover:bg-gray-800 transition-colors">
              <div className="text-center">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gray-700 rounded-full flex items-center justify-center text-white font-bold text-sm sm:text-lg mx-auto mb-2 sm:mb-3">
                  #{index + 1}
                </div>
                {artist.imageUrl && (
                  <img 
                ...
                <h4 className="font-medium text-white text-xs sm:text-sm mb-1 truncate px-1" title={artist.name}>{artist.name}</h4>
