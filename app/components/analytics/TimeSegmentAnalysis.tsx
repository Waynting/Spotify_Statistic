  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-black border border-gray-800 rounded-xl p-4 sm:p-6 overflow-x-auto">
        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 text-center">時間段聆聽分佈圓餅圖</h3>
        <div className="h-[350px] sm:h-[500px] min-w-[300px] sm:min-w-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        {data.map((segment, index) => {
          ...
          return (
            <div key={segment.segment} className="bg-black border border-gray-800 rounded-xl p-4 sm:p-6 hover:border-gray-700 transition-colors">
