  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-black border border-gray-800 rounded-xl p-4 sm:p-6 overflow-x-auto">
        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 text-center">曲風分佈圓餅圖</h3>
        <div className={isSnapshot ? "h-[400px] sm:h-[600px]" : "h-[350px] sm:h-[500px] min-w-[300px] sm:min-w-0"}>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6">完整曲風清單</h3>
            ...
            <div key={genre.name} className="bg-gray-800/50 rounded-lg p-3 hover:bg-gray-800 transition-colors">
              <div className="flex items-center justify-between gap-2 min-w-0">
                <div className="flex items-center gap-2 min-w-0 flex-1">
                  ...
                  />
                  <span className="text-white text-xs sm:text-sm font-medium truncate" title={getGenreLabel(genre.name)}>{getGenreLabel(genre.name)}</span>
                </div>
                <div className="text-right flex-shrink-0">
                  <div className="text-white text-xs sm:text-sm font-medium">{genre.percentage}%</div>
