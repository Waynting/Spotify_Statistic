...
export default function Analytics() {
  ...
  return (
    <div className="min-h-screen bg-black w-full max-w-full overflow-x-hidden">
      <div className="p-4 sm:p-6 lg:p-8 w-full max-w-full min-w-0">
        {/* Header */}
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-8 gap-6">
          ...
          <button
            onClick={() => refetch()}
            className="bg-gray-900 hover:bg-gray-800 border border-gray-700 text-white px-4 py-3 sm:px-4 rounded-lg flex items-center gap-2 transition-colors text-sm sm:text-base min-h-[44px] min-w-[44px] justify-center"
          >
        ...
        <div className="mb-8">
            ...
            {ANALYSIS_TYPES.map((type) => {
              ...
              return (
                <button
                  ...
                  className={`
                    px-4 py-3 rounded-xl transition-all duration-200 flex items-center gap-3 min-h-[44px]
          ...
          <div className="sm:hidden relative" ref={analysisMenuRef}>
            <button
              ...
              className="w-full p-3 bg-gray-900 border border-gray-700 rounded-xl text-white hover:bg-gray-800 transition-all duration-200 min-h-[44px]"
            >
            ...
            {isAnalysisMenuOpen && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-gray-900 border border-gray-700 rounded-xl shadow-xl z-50 max-h-60 overflow-y-auto w-full">
                {ANALYSIS_TYPES.map((type) => {
                  const Icon = type.icon
                  return (
                    <button
                      ...
                      className={`
                        w-full p-3 text-left hover:bg-gray-800 transition-all duration-200 first:rounded-t-xl last:rounded-b-xl min-h-[44px]
