...
export default function Settings() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-4xl w-full max-w-full overflow-x-hidden">
      <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-white">設定</h1>
            ...
            <div className="flex items-center justify-between">
              ...
              {isAuthenticated ? (
                <button
                  ...
                  className="bg-gray-800 hover:bg-gray-700 text-white px-4 py-3 rounded border border-gray-700 flex items-center gap-2 transition-colors min-h-[44px]"
                >
                ...
                <button
                  onClick={handleLogin}
                  disabled={isLoading}
                  className="bg-white hover:bg-gray-100 text-black px-4 py-3 rounded flex items-center gap-2 disabled:opacity-50 transition-colors min-h-[44px]"
                >
                  {isLoading ? (
                  ...
                  <span>{isLoading ? '認證中...' : '連接 Spotify'}</span>
                </button>
              )}
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-900/20 border border-blue-800/50 rounded-lg p-4">
                  <p className="text-sm text-blue-300 mb-2">
                    <strong>資料儲存說明</strong>
                  </p>
                  <p className="text-sm text-gray-400">
                    為提供更準確的歷史聆聽分析，我們會將您的播放紀錄安全地儲存在資料庫中。您的資料受到加密保護，且您可以隨時要求刪除。
                  </p>
                </div>
        ...
        <section className="bg-black border border-gray-800 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <button
                onClick={clearTokens}
                className="bg-gray-900 hover:bg-gray-800 text-white px-4 py-3 rounded border border-gray-700 flex items-center gap-2 transition-colors min-h-[44px]"
              >
                <RefreshCw size={16} />
                清除認證資料
              </button>
