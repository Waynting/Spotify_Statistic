      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-2">
            <Camera className="text-white flex-shrink-0" size={24} />
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">數據快照</h1>
          </div>
          <p className="text-sm sm:text-base text-gray-400">選擇分析區段並生成個人化音樂統計截圖</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
                ...
                {DATA_SECTIONS.map((section) => {
                  ...
                  return (
                    <div
                      ...
                      className={`
                        p-3 rounded-lg border cursor-pointer transition-all duration-200 min-h-[44px]
                        ${isSelected 
                ...
                <div className="grid grid-cols-2 gap-2">
                  {ANALYTICS_TIME_WINDOWS.map((window) => (
                    <button
                      ...
                      className={`
                        p-2 rounded-lg text-xs font-medium transition-all duration-200 min-h-[44px]
              ...
              <button
                ...
                className={`
                  w-full mt-6 p-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 min-h-[44px]
          ...
          <div className="lg:col-span-3 min-w-0">
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6 overflow-x-auto">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 mb-4 sm:mb-6">
                <h2 className="text-base sm:text-lg font-semibold text-white">預覽</h2>
